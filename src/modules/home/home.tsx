    ...
    return (
      <div className="home">
        ...
        <article>
          ...
          left off later. Utilizing state-of-the-art cyber magic like React ⚛️ and
          WebSQL 💾, Do. keeps track of your tasks exactly as well as you take
          care of your browser's data.
          </p>
          <div className="call-to-action">
            <Link to="/dashboard" className="button">Go To App</Link>
          </div>
        </article>
      </div>
    )
